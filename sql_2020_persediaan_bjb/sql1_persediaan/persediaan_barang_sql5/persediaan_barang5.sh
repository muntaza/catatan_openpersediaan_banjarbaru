...
cat persediaan_barang5_dinas_pendidikan.sql | sed -e s/dinas_pendidikan/upt_pajak_daerah_wilayah_i/g | sed -e s/"id_skpd = 1"/"id_skpd = 78"/g > persediaan_barang5_upt_pajak_daerah_wilayah_i.sql
cat persediaan_barang5_dinas_pendidikan.sql | sed -e s/dinas_pendidikan/upt_pajak_daerah_wilayah_ii/g | sed -e s/"id_skpd = 1"/"id_skpd = 79"/g > persediaan_barang5_upt_pajak_daerah_wilayah_ii.sql
...
cat persediaan_barang5_dinas_pendidikan.sql | sed -e s/dinas_pendidikan/sdn_3_landasan_ulin_barat/g | sed -e s/"id_skpd = 1"/"id_skpd = 242"/g > persediaan_barang5_sdn_3_landasan_ulin_barat.sql
cat persediaan_barang5_dinas_pendidikan.sql | sed -e s/dinas_pendidikan/sdn_3_landasan_ulin_utara/g | sed -e s/"id_skpd = 1"/"id_skpd = 243"/g > persediaan_barang5_sdn_3_landasan_ulin_utara.sql
...
cat persediaan_barang5_dinas_pendidikan.sql | sed -e s/dinas_pendidikan/pkm_landasan_ulin_timur/g | sed -e s/"id_skpd = 1"/"id_skpd = 175"/g > persediaan_barang5_pkm_landasan_ulin_timur.sql
