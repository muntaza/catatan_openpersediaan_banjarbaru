...
cat kartu_barang2_dinas_pendidikan.sql | sed -e s/dinas_pendidikan/sdn_3_landasan_ulin_barat/g | sed -e s/"id_skpd = 1"/"id_skpd = 242"/g > kartu_barang2_sdn_3_landasan_ulin_barat.sql
cat kartu_barang2_dinas_pendidikan.sql | sed -e s/dinas_pendidikan/sdn_3_landasan_ulin_utara/g | sed -e s/"id_skpd = 1"/"id_skpd = 243"/g > kartu_barang2_sdn_3_landasan_ulin_utara.sql
